...
ASR_MODEL_CACHE_DIR = os.environ.get("ASR_MODEL_CACHE_DIR", "/opt/asr-service/models")
...
ASR_LLM_LOG_FILE = os.environ.get("ASR_LLM_LOG_FILE", "/opt/asr-service/llama-server.log")
ASR_LLM_PID_FILE = os.environ.get("ASR_LLM_PID_FILE", "/opt/asr-service/llama-server.pid")
